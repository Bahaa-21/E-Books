...
namespace E_Books.Migrations
{
    ...
    [Migration("20230318190921_AddEmailColumnInOrderTable")]
    partial class AddEmailColumnInOrderTable
    {
            ...
            modelBuilder.Entity("E_Books.DataAccessLayer.Models.CartBook", b =>
                {
                    ...
                    b.Property<DateTime>("AddedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 18, 22, 9, 21, 581, DateTimeKind.Local).AddTicks(8659));
            ...
            modelBuilder.Entity("E_Books.DataAccessLayer.Models.Book", b =>
                {
                    ...
                    b.HasOne("E_Books.DataAccessLayer.Models.Publisher", "Publishers")
                        .WithMany("Books")
            ...
            modelBuilder.Entity("E_Books.DataAccessLayer.Models.CartBook", b =>
                {
                    ...
                    b.HasOne("E_Books.DataAccessLayer.Models.Carts", "Carts")
                        .WithMany("CartBooks")
